...
gdjs.copyArray(runtimeScene.getObjects("Movimento"), gdjs.Modulo_323Code.GDMovimentoObjects1);
...
{for(var i = 0, len = gdjs.Modulo_323Code.GDMovimentoObjects1.length ;i < len;++i) {
    gdjs.Modulo_323Code.GDMovimentoObjects1[i].hide();
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSecondsOrNaN(runtimeScene, "ShowMovimentoTimer") >= 1;
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Movimento"), gdjs.Modulo_323Code.GDMovimentoObjects1);
{for(var i = 0, len = gdjs.Modulo_323Code.GDMovimentoObjects1.length ;i < len;++i) {
    gdjs.Modulo_323Code.GDMovimentoObjects1[i].hide(false);
}
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSecondsOrNaN(runtimeScene, "ShowFood1Timer") >= 6.5;
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("NewSprite2"), gdjs.Modulo_323Code.GDNewSprite2Objects1);
{for(var i = 0, len = gdjs.Modulo_323Code.GDNewSprite2Objects1.length ;i < len;++i) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSecondsOrNaN(runtimeScene, "ShowFood2Timer") >= 7;
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("NewSprite"), gdjs.Modulo_323Code.GDNewSpriteObjects1);
{for(var i = 0, len = gdjs.Modulo_323Code.GDNewSpriteObjects1.length ;i < len;++i) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSecondsOrNaN(runtimeScene, "ShowFood3Timer") >= 7.5;
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("NewSprite5"), gdjs.Modulo_323Code.GDNewSprite5Objects1);
{for(var i = 0, len = gdjs.Modulo_323Code.GDNewSprite5Objects1.length ;i < len;++i) {
